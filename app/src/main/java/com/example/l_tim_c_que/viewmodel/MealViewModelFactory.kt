...
class MealViewModelFactory (
     ...
     * @throws IllegalArgumentException if the given `modelClass` is not a [MealViewModel].
     */
    override fun <T: ViewModel> create(modelClass: Class<T>): T {
        ...
        if(modelClass.isAssignableFrom(MealViewModel::class.java)) {
            ...
            return MealViewModel(repository) as T //its safe since there is an if statement to check
        }
